...
async function loginUser(plant) {
    return fetch('http://localhost/2020566/nursery/api/plants', {
        method: 'POST',
        headers: {
                                ...
                                <div className="d-block mt-3">
                                    <form onSubmit={this.handleSubmit}>
                                        ...
                                        <div className="form-group">
                                            ...
                                            <input type="url" value={this.state.img}
                                                   onChange={e => this.setState({img: e.target.value})}
                                                   placeholder="Image URL" id="img"
                                                   className="form-control"/>
                                        </div>

                                        <div className="form-group">
                                            <label>Special Features</label>
                                            <textarea className="form-control" value={this.state.special_feature}
                                                      onChange={e => this.setState({special_feature: e.target.value})}
